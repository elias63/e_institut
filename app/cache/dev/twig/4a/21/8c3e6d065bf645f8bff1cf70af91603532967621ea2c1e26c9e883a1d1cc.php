...
/* EieinstitutBundle:Pages:Liste_actualite.html.twig */
class __TwigTemplate_4a218c3e6d065bf645f8bff1cf70af91603532967621ea2c1e26c9e883a1d1cc extends Twig_Template
{
...
\t\t\t\t\t\t\t<a href=\"#\"><img src=\"";
        ...
        echo "\" width=\"180\" height=\"120\"></a>
\t\t\t\t\t\t
\t\t\t\t\t
\t\t\t\t\t
\t\t\t\t\t\t<section class=\"grid_6\">
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t<div class=\"task-description margin-left\">
\t\t\t\t\t\t\t\t\t<h3>Task name</h3><p class=\"float-right Date\">Date:01/01/2014</p>
                                                                        <br>
...
\t\t\t\t\t</li>
\t\t\t\t</ul>\t\t\t\t\t
\t\t\t</div>\t\t\t\t\t<ul class=\"message no-margin\">
...
";
    ...
    {
        return "EieinstitutBundle:Pages:Liste_actualite.html.twig";
    }
