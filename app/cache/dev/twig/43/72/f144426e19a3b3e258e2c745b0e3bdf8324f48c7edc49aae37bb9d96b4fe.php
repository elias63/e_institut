...
/* EiAdministrationBundle:Contributor:c_ajouter_ressource.html.twig */
class __TwigTemplate_4372f144426e19a3b3e258e2c745b0e3bdf8324f48c7edc49aae37bb9d96b4fe extends Twig_Template
{
...
\t\t\t
\t\t\t<span class=\"float-left\">Nouvelle ressource</span>
\t
\t</div>
\t\t\t
\t
...
\t\t\t\t\t\t\t\t\t\t\t URL 
\t\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t<input id=\"complex-fr-subtitle\" class=\"full-width\" type=\"text\" value=\"\" name=\"url\"> <br><br>
\t\t\t\t\t\t\t\t<div class=\"columns\">
\t\t\t\t\t\t\t<p class=\"colx2-left\">
\t\t\t\t\t\t\t\t\t<span class=\"label required\">
\t\t\t\t\t\t\t\t\t\t\tTags
...
";
    ...
    {
        return "EiAdministrationBundle:Contributor:c_ajouter_ressource.html.twig";
    }
