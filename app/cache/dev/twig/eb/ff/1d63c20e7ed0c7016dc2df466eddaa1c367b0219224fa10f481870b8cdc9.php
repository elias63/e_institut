...
/* EiAdministrationBundle:Contributor:c_modifier_actualite.html.twig */
class __TwigTemplate_ebff1d63c20e7ed0c7016dc2df466eddaa1c367b0219224fa10f481870b8cdc9 extends Twig_Template
{
...
\t\t\t
\t\t\t<span class=\"float-left\">Modifier actualité</span>
\t
\t</div>
\t\t\t
\t
...
\t\t\t\t\t\t\t\t\tTitre 
\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"complex-fr-subtitle\" id=\"complex-fr-subtitle\" value=\"";
            // line 43
...
\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"complex-fr-subtitle\" id=\"complex-fr-subtitle\" value=\"";
            // line 49
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["actualite"]) ? $context["actualite"] : $this->getContext($context, "actualite")), "urlimage"), "html", null, true);
            echo "\" class=\"full-width\" >
\t\t\t\t\t\t\t</p>\t
\t\t\t\t\t\t</div>
\t\t\t\t\t\t
...
\t\t\t\t\t\t\t\t\tDate de publication
\t\t\t\t\t\t</span>
\t\t\t\t\t\tDu :<span class=\"input-type-text margin-right relative\"><input type=\"text\" name=\"simple-calendar\" id=\"simple-calendar\" value=\"";
            // line 66
            ...
            echo "\" class=\"datepicker hasDatepick\"><img src=\"";
...
\t\t\t\t\t\tAu :<span class=\"input-type-text margin-right relative\"><input type=\"text\" name=\"simple-calendar\" id=\"simple-calendar\" value=\"";
            // line 67
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["actualite"]) ? $context["actualite"] : $this->getContext($context, "actualite")), "dateexpiration"), "d-m-Y"), "html", null, true);
            echo "\" class=\"datepicker hasDatepick\"><img src=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/eieinstitut/images/icons/fugue/calendar-month.png"), "html", null, true);
            echo "\" width=\"16\" height=\"16\"></span>
\t\t\t\t\t\t
...
";
    ...
    {
        return "EiAdministrationBundle:Contributor:c_modifier_actualite.html.twig";
    }
