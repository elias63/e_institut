...
/* EiAdministrationBundle:Contributor:c_modifier_image.html.twig */
class __TwigTemplate_665564b368f43db8aa4ba50e20a94abaf017bb31c5823ced022089a7a42c7f97 extends Twig_Template
{
...
\t
\t\t<a href=\"javascript:void(0)\" class=\"button\" title=\"\"> <strong>Toutes les image</strong></a>
\t\t\t
\t\t\t<span class=\"float-left\">Modifier image</span>
\t
\t</div>
\t\t\t
\t
...
\t\t\t\t\t\t<button type=\"button\">Télecharger</button>
\t\t\t\t\t\t<ul class=\"files\">
...
\t\t\t\t\t\t\t\t\t\t<span><img src=\"";
        ...
        echo "\" width=\"64\" height=\"45\" class=\"thumb\"></span>
\t\t\t\t\t\t\t\t\t\tConcept car.jpg
\t\t\t\t\t\t\t\t\t</a></li>
\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t</ul>
...
";
    ...
    {
        return "EiAdministrationBundle:Contributor:c_modifier_image.html.twig";
    }
