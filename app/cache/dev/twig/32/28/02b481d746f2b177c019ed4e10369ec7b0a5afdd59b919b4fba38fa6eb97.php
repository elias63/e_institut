...
/* EiAdministrationBundle:admin:a_modifier_ressource.html.twig */
class __TwigTemplate_322802b481d746f2b177c019ed4e10369ec7b0a5afdd59b919b4fba38fa6eb97 extends Twig_Template
{
...
\t
\t\t<a href=\"javascript:void(0)\" class=\"button\" title=\"\"> <strong>Toutes les ressources</strong></a>
\t\t\t
\t\t\t<span class=\"float-left\">Modifier ressource</span>
\t
\t</div>
\t\t\t
\t
\t<br><br>
                                                ";
        // line 32
        $context["titre"] = $this->getAttribute((isset($context["Fiche"]) ? $context["Fiche"] : $this->getContext($context, "Fiche")), "titre");
        echo "   
                                                ";
        // line 33
        $context["tags"] = "";
        echo " 
                                                ";
        // line 34
        $context["domaine"] = $this->getAttribute((isset($context["Fiche"]) ? $context["Fiche"] : $this->getContext($context, "Fiche")), "domaine");
        // line 35
        echo "                                                ";
        $context["theme"] = $this->getAttribute((isset($context["Fiche"]) ? $context["Fiche"] : $this->getContext($context, "Fiche")), "theme");
        // line 36
        echo "                                                ";
        $context["url"] = $this->getAttribute((isset($context["Fiche"]) ? $context["Fiche"] : $this->getContext($context, "Fiche")), "url");
        // line 37
        echo "                                                ";
        $context["type"] = $this->getAttribute((isset($context["Fiche"]) ? $context["Fiche"] : $this->getContext($context, "Fiche")), "type");
        echo "          
                                                ";
        // line 38
        $context["description"] = $this->getAttribute((isset($context["Fiche"]) ? $context["Fiche"] : $this->getContext($context, "Fiche")), "resume");
        // line 39
        echo "\t\t\t\t\t<form class=\"block-content form\" id=\"simple_form\" method=\"post\" action=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ei_administration_modifier_ressource", array("id" => $this->getAttribute((isset($context["Fiche"]) ? $context["Fiche"] : $this->getContext($context, "Fiche")), "id"))), "html", null, true);
        echo "\">
\t\t\t\t
...
\t\t\t\t\t\t\t\t<input id=\"complex-fr-subtitle\" class=\"full-width\" type=\"text\" value=\"";
        ...
        echo "\" name=\"url\"></input> <br><br>
\t\t\t\t\t\t\t\t<div class=\"columns\">
\t\t\t\t\t\t\t<p class=\"colx2-left\">
\t\t\t\t\t\t\t\t\t<span class=\"label required\">
\t\t\t\t\t\t\t\t\t\t\tTags
\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t<input id=\"complex-fr-subtitle\" class=\"full-width\" type=\"text\" value=\"\" name=\"tags\"> </input><br><br>
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t<p class=\"colx2-right\">
\t\t\t\t\t\t\t<span class=\"label \">
...
\t\t\t\t\t\t<option value=\"Développemnt\">Développemnt</option>
\t\t\t\t\t\t<option value=\"Réseau\">Réseau</option>
\t\t\t\t\t</select><br><br>\t--><input id=\"complex-fr-subtitle\" class=\"full-width\" type=\"text\" value=\"";
        // line 104
...
";
    ...
    {
        return "EiAdministrationBundle:admin:a_modifier_ressource.html.twig";
    }
