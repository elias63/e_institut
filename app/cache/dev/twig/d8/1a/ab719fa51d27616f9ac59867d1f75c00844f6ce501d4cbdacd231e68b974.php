...
/* EiAdministrationBundle:Contributor:c_liste_user.html.twig */
class __TwigTemplate_d81aab719fa51d27616f9ac59867d1f75c00844f6ce501d4cbdacd231e68b974 extends Twig_Template
{
...
\t\t\t\t<div class=\"legend\">Utilisateurs</div>
\t\t\t\t\t
\t\t\t
\t\t\t
\t\t\t
...
\t\t
\t\t
\t\t\t<span class=\"float-left\">Tous les utilisateurs</span>
\t
\t</div>
\t
\t
...
\t\t\t\t\t\t\t<td>Ali</td>
\t\t\t\t\t\t\t<td>admin</td>
\t\t\t\t\t\t\t<td>admin1@einstitut.net</td>
\t\t\t\t\t\t\t
\t\t\t\t\t\t\t
\t\t\t\t\t\t\t<td class=\"table-actions\">
\t\t\t\t\t\t\t\t<a href=\"javascript:void(0)\" title=\"Contacter\" class=\"with-tip\"><img src=\"";
        // line 97
...
";
    ...
    {
        return "EiAdministrationBundle:Contributor:c_liste_user.html.twig";
    }
