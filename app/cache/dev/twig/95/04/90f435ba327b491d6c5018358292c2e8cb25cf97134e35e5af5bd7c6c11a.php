...
/* EiAdministrationBundle:admin:a_liste_page.html.twig */
class __TwigTemplate_950490f435ba327b491d6c5018358292c2e8cb25cf97134e35e5af5bd7c6c11a extends Twig_Template
{
...
\t\t\t\t\t\t\t
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["ps"]) {
            echo "        
                                                    ...
                                                    <td>";
            // line 88
            if ($this->getAttribute((isset($context["ps"]) ? $context["ps"] : $this->getContext($context, "ps")), "etat")) {
                echo "activé";
            } else {
                echo "désactivé ";
            }
            echo "</td> <td>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["ps"]) ? $context["ps"] : $this->getContext($context, "ps")), "titre"), "html", null, true);
            echo "</td> <td>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["ps"]) ? $context["ps"] : $this->getContext($context, "ps")), "description"), "html", null, true);
            echo "</td><td>";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : $this->getContext($context, "ps")), "rubriquesPage"), "nom"), "html", null, true);
            echo "</td><td>";
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["ps"]) ? $context["ps"] : $this->getContext($context, "ps")), "dateCreation"), "m/d/Y"), "html", null, true);
            echo "</td>
                                                    <td class=\"table-actions\">
\t\t\t\t\t\t\t\t<a href=\"";
            // line 90
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("modifier_page", array("id" => $this->getAttribute((isset($context["ps"]) ? $context["ps"] : $this->getContext($context, "ps")), "id"))), "html", null, true);
...
\t\t\t\t\t\t\t\t<a onclick=\"Supprimer(";
            // line 92
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["ps"]) ? $context["ps"] : $this->getContext($context, "ps")), "id"), "html", null, true);
...
";
    ...
    { 
        ...
        if (confirmation){
             ...
             \$.post(\"";
        // line 139
        echo $this->env->getExtension('routing')->getPath("ei_administration_supprimer_page");
        echo "\",{idPage:id},function(result){\$('html').load('";
...
";
    ...
    {
        return "EiAdministrationBundle:admin:a_liste_page.html.twig";
    }
