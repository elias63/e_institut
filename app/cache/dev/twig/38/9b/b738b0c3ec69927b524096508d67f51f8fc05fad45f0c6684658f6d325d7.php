...
/* EiAdministrationBundle:Contributor:c_liste_abonnement.html.twig */
class __TwigTemplate_389bb738b0c3ec69927b524096508d67f51f8fc05fad45f0c6684658f6d325d7 extends Twig_Template
{
...
\t\t<a href=\"javascript:void(0)\" class=\"button\" title=\"Ajouter\"><img src=\"";
        ...
        echo "\" width=\"16\" height=\"16\"> <strong>Nouveau groupe</strong></a>
\t\t<a href=\"javascript:void(0)\" class=\"button\" title=\"Ajouter\"><img src=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/eieinstitut/images/icons/fugue/plus-circle.png"), "html", null, true);
...
\t\t
\t\t\t
\t\t\t<span class=\"float-left\">Liste des abonnés</span>
\t
\t</div>
\t
\t<br><br>
...
\t\t\t\t\t\t\t\t<li class=\"current\"><a href=\"#tab-liste\" title=\"Commentaires\">Abonnés</a></li>
\t\t\t\t\t\t\t\t<li><a href=\"#tab-groupe\" title=\"Options\">Groupes</a></li>
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t</ul>
...
\t\t\t\t\t\t\t\t<!--commentaires-->
\t\t\t\t\t\t\t\t<div id=\"tab-liste\" style=\"height: 519px;\">
...
\t\t\t\t\t\t\t\t<div id=\"tab-groupe\" style=\"height: 519px; display: none;\">
\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t<form class=\"block-content form\" id=\"table_form\" method=\"post\" action=\"#\">
\t\t\t\t
\t\t\t\t
...
\t\t\t\t\t\t\t
\t\t\t\t\t\t\t<td class=\"table-actions\">
\t\t\t\t\t\t\t\t<a href=\"javascript:void(0)\" title=\"Modiffier\" class=\"with-tip\"><img src=\"";
        // line 208
...
";
    ...
    {
        return "EiAdministrationBundle:Contributor:c_liste_abonnement.html.twig";
    }
