...
/* EiAdministrationBundle:admin:a_liste_critere.html.twig */
class __TwigTemplate_74dce5fa9c83dcb054ae2d89da0ae5d6035c2e7665c6af8986391d8c2d1ae6fe extends Twig_Template
{
...
\t\t
\t\t\t
\t\t\t<span class=\"float-left\">Toutes les criteres</span>
\t
\t</div>
\t
\t
...
\t\t\t\t\t\t\t
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["ct"]) {
            echo "        
                                                    ...
                                                    <td>";
            // line 74
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["ct"]) ? $context["ct"] : $this->getContext($context, "ct")), "id"), "html", null, true);
            echo "</td><td>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["ct"]) ? $context["ct"] : $this->getContext($context, "ct")), "libelle"), "html", null, true);
            echo "</td>
                                                    <td class=\"table-actions\">
\t\t\t\t\t\t\t\t<a href=\"";
            // line 76
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ei_administration_modifier_preconisation", array("id" => $this->getAttribute((isset($context["ct"]) ? $context["ct"] : $this->getContext($context, "ct")), "id"))), "html", null, true);
...
\t\t
\t\t\t
\t\t\t<span class=\"float-left\">Toutes les notes</span>
\t
\t</div>
\t
\t
...
\t\t\t\t\t\t\t
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["nt"]) {
            echo "        
                                                    ...
                                                    <td>";
            // line 175
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["nt"]) ? $context["nt"] : $this->getContext($context, "nt")), "id"), "html", null, true);
            echo "</td><td>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["nt"]) ? $context["nt"] : $this->getContext($context, "nt")), "libelle"), "html", null, true);
            echo "</td><td>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["nt"]) ? $context["nt"] : $this->getContext($context, "nt")), "annotation"), "html", null, true);
            echo "</td>
                                                    <td class=\"table-actions\">
\t\t\t\t\t\t\t\t<a href=\"";
            // line 177
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ei_administration_modifier_note", array("id" => $this->getAttribute((isset($context["nt"]) ? $context["nt"] : $this->getContext($context, "nt")), "id"))), "html", null, true);
            echo "\" title=\"Modifier\" class=\"with-tip\"><img src=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/eiadministration/images/icons/fugue/pencil.png"), "html", null, true);
            echo "\" width=\"16\" height=\"16\"></a>
\t\t\t\t\t\t\t\t<a onclick=\"SupprimerN(";
            // line 178
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["nt"]) ? $context["nt"] : $this->getContext($context, "nt")), "id"), "html", null, true);
            echo ")\" title=\"Metttre dans la corbeille\" class=\"with-tip\"><img src=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/eiadministration/images/icons/fugue/cross-circle.png"), "html", null, true);
...
";
    ...
    { 
        var confirmation=confirm(\"Voulez-vous supprimer Critere:\"+id);
        if (confirmation){
             console.log(\"test supp\",id);
             \$.post(\"";
        // line 224
        echo $this->env->getExtension('routing')->getPath("ei_administration_supprimer_preconisation");
        echo "\",{idCritere:id},function(result){\$('html').load('";
        echo $this->env->getExtension('routing')->getPath("ei_administration_preconisation");
        echo "');});
                         }
    }
    function SupprimerN(id) 
    { 
        var confirmation=confirm(\"Voulez-vous supprimer Note:\"+id);
        if (confirmation){
             console.log(\"test supp\",id);
             \$.post(\"";
        // line 232
        echo $this->env->getExtension('routing')->getPath("ei_administration_supprimer_preconisation");
        echo "\",{idNote:id},function(result){\$('html').load('";
        echo $this->env->getExtension('routing')->getPath("ei_administration_preconisation");
        echo "');});
                         }
    }
...
";
    ...
    {
        return "EiAdministrationBundle:admin:a_liste_critere.html.twig";
    }
