...
class __TwigTemplate_1bd4db9504a3404701e111d276e93d041ee70c2bb58c3101b066f3fc4dc6666d extends Twig_Template
{
...
\t\t<ul class=\"container_12\">
                        ";
        // line 21
        $context["CurrentMenu"] = $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "session"), "get", array(0 => "CurrentMenu"), "method");
        // line 22
        echo "                        ";
        $context["index"] = "";
        // line 23
        ...
        echo "                        
                        ";
        // line 30
        if (((isset($context["CurrentMenu"]) ? $context["CurrentMenu"] : null) == "index")) {
            // line 31
            echo "                            ";
            $context["index"] = "current";
            // line 32
            echo "                        ";
        } elseif (((isset($context["CurrentMenu"]) ? $context["CurrentMenu"] : null) == "EspacePersonnel")) {
            // line 33
            echo "                            ";
            $context["EspacePersonnel"] = "current";
            // line 34
            echo "                        ";
        } elseif (((isset($context["CurrentMenu"]) ? $context["CurrentMenu"] : null) == "Ressources")) {
            // line 35
            echo "                            ";
            $context["Ressources"] = "current";
            // line 36
            echo "                        ";
        } elseif (((isset($context["CurrentMenu"]) ? $context["CurrentMenu"] : null) == "TutorielsEnLigne")) {
            // line 37
            echo "                            ";
            $context["TutorielsEnLigne"] = "current";
            // line 38
            echo "                        ";
        } elseif (((isset($context["CurrentMenu"]) ? $context["CurrentMenu"] : null) == "Annuaire")) {
            // line 39
            echo "                            ";
            $context["Annuaire"] = "current";
            // line 40
            echo "                        ";
        } elseif (((isset($context["CurrentMenu"]) ? $context["CurrentMenu"] : null) == "Forum")) {
            // line 41
            echo "                            ";
            $context["Forum"] = "current";
            // line 42
            echo "                        ";
        } elseif (((isset($context["CurrentMenu"]) ? $context["CurrentMenu"] : null) == "Actualites")) {
            // line 43
            echo "                            ";
        ...
        if ($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user")) {
            // line 48
            echo "\t\t\t<li class=\"users ";
            echo twig_escape_filter($this->env, (isset($context["EspacePersonnel"]) ? $context["EspacePersonnel"] : null), "html", null, true);
        ...
        echo twig_escape_filter($this->env, (isset($context["Ressources"]) ? $context["Ressources"] : null), "html", null, true);
        ...
        if ($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user")) {
            ...
            echo twig_escape_filter($this->env, (isset($context["TutorielsEnLigne"]) ? $context["TutorielsEnLigne"] : null), "html", null, true);
...
\t\t\t<li class=\"contacts ";
            // line 64
            echo twig_escape_filter($this->env, (isset($context["Annuaire"]) ? $context["Annuaire"] : null), "html", null, true);
        ...
        echo twig_escape_filter($this->env, (isset($context["Forum"]) ? $context["Forum"] : null), "html", null, true);
        echo "\" title=\"Forum\"><a href=\"";
        echo $this->env->getExtension('routing')->getPath("Forum");
        echo "\" title=\"\">Forum</a></li>
                        <li class=\"write ";
        // line 67
        echo twig_escape_filter($this->env, (isset($context["Actualites"]) ? $context["Actualites"] : null), "html", null, true);
        echo "\"><a href=\"";
...
\t\t<div class=\"container_12\">
                        ";
        // line 89
        $context["messages"] = $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "session"), "get", array(0 => "messages"), "method");
        // line 90
...
\t\t\t\t<a href=\"#\" class=\"button\" title=\"";
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "session"), "get", array(0 => "msg"), "method"), "html", null, true);
            echo "</strong></a>
...
\t\t\t\t\t\t\t<strong>";
                // line 111
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["msg"]) ? $context["msg"] : null), "dateMessage"), "H:II"), "html", null, true);
                echo "</strong>
\t\t\t\t\t\t\t";
                // line 112
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["msg"]) ? $context["msg"] : null), "objet"), "html", null, true);
                echo "<br>
\t\t\t\t\t\t\t<small>De : ";
                // line 113
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["msg"]) ? $context["msg"] : null), "messagesuser"), "username"), "html", null, true);
                echo "</small></a>
\t\t\t\t\t\t</li>
\t\t\t\t\t\t";
            }
...
\t\t\t\t<a href=\"#\" class=\"button\" title=\"2 comments\"><img src=\"";
            ...
            echo "\" width=\"16\" height=\"16\"> <strong>";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "session"), "get", array(0 => "notif"), "method"), "html", null, true);
            echo "</strong></a>
